	    ...
	    static void currencyConvert(int value) 
	    {
	       ...
	       switch (value)
	       {
	            ...
	            case 2:
	                ...
	                break;
	            case 3:
	                System.out.println("Australian dollar (AUD) value of " + dollorValue + "dollor is " + (dollorValue * 1.53));
	                break;
	            case 4:
	                System.out.println("Canadian dollar (CAD) value of " + dollorValue + "dollor is " + (dollorValue * 1.34));
	                break;
	            case 5:
	                System.out.println("Swiss franc (CHF) value of " + dollorValue + "dollor is " + (dollorValue * 0.98));
	                break;
	            case 6:
	                System.out.println("Indian Rupee (INR) value of " + dollorValue + "dollor is " + (dollorValue * 81.31));
	                break;
